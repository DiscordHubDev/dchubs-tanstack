...
import { authUser, authSession, authAccount, user, apiKey, bot, botCommand, report, review, server, vote, serverAdmins, botDevelopers, userFavoriteBots, userFavoriteServers } from "./schema";
...
export const userFavoriteBotsRelations = relations(userFavoriteBots, ({one}) => ({
	bot: one(bot, {
...
export const userFavoriteServersRelations = relations(userFavoriteServers, ({one}) => ({
	server: one(server, {
