...
export const BotCategorySchema = Schema.Literal("popular", "featured", "new", "verified", "voted");

const PositiveIntLikeSchema = Schema.Union(Schema.Number, Schema.NumberFromString).pipe(
  Schema.int(),
