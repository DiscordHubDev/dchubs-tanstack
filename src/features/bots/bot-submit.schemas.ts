...
export type UploadBotImagesInput = Schema.Schema.Type<typeof UploadBotImagesInputSchema>;
export type DeleteBotImageInput = Schema.Schema.Type<typeof DeleteBotImageInputSchema>;
export type SendPendingWebhookInput = Schema.Schema.Type<typeof SendPendingWebhookSchema>;
