...
export function sortBotsByCategory(bots: PublicBot[], category: BotCategory): PublicBot[] {
  const botsCopy = [...bots];
...
export function filterBotsBySearch(bots: PublicBot[], query: string): PublicBot[] {
...
export function paginateBots(bots: PublicBot[], page: number, pageSize: number) {
