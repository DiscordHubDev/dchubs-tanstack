...
export const UpdateReportSchema = Schema.Struct({
  ...
  severity: Schema.optional(Schema.Literal("untagged", "low", "moderate", "severe")),
});
...
export const QuerySchema = Schema.Struct({
  ...
  page: Schema.optional(Schema.Number.pipe(Schema.int(), Schema.greaterThanOrEqualTo(1))).pipe(
