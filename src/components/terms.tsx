						...
						<div className="space-y-12">
							<section id="introduction" className="scroll-mt-8">
								...
								<p className="leading-relaxed">
									...
									伺服器與機器人的展示、搜索及列表服務。
									當您透過瀏覽器存取、使用本平台或透過 Discord
									授權登入時，即表示您已閱讀、理解並同意接受本服務條款的約束。
							...
							<section id="usage-rules" className="scroll-mt-8">
								...
								<p className="mb-3">
									使用者在本平台上提交、宣傳的伺服器或機器人，必須嚴格遵守以下規範以及
									Discord 官方的
									<a
							...
							<section id="disclaimer" className="scroll-mt-8">
								...
								<ul className="list-disc pl-5 space-y-3">
									...
									<li>
										...
										您在邀請機器人或加入外部伺服器互動時，須自行承擔全數風險。若因此導致您的
										Discord 帳號遭停權、伺服器毀損或數據遺失，本平台概不負責。
									</li>
									<li>
										<strong>服務可用性：</strong>{" "}
										平台依照「現況（As-is）」及「現有技術」提供服務。
							...
							<section id="changes" className="scroll-mt-8">
								...
								<p className="leading-relaxed">
									<strong>管理權限與服務終止：</strong> 本平台保留隨時在{" "}
									<strong>不另行通知</strong> 的情況下，
