...
const EQ_DELAYS: readonly number[] = [0, 0.1, 0.2, 0.32, 0.44, 0.56, 0.44, 0.32, 0.2, 0.1, 0];
const EQ_MAX_H: readonly number[] = [22, 30, 40, 50, 58, 64, 58, 50, 40, 30, 22];
const EQ_PERIODS: readonly number[] = [1.1, 1.0, 1.25, 1.05, 1.15, 1.0, 1.2, 1.1, 1.05, 1.15, 1.1];
    ...
    <output aria-label={loadingText} style={rootStyle}>
      ...
      {PARTICLES.map((p, i) => (
        <div
          ...
          key={i}
          aria-hidden="true"
          className="absolute h-[5px] w-[5px] rounded-full bg-[rgba(88,101,242,0.55)] pointer-events-none"
          style={{
            left: p.left,
            top: p.top,
      ...
      <div style={contentStyle}>
        ...
        {showTips && tips.length > 0 && (
          <div key={tipIndex} style={tipCardStyle}>
            ...
            <p style={{ color: "#b5bac1", fontSize: 12.5, margin: 0 }}>{tips[tipIndex]}</p>
          </div>
        )}
      </div>
    </output>
