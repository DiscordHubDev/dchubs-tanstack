...
import type {
	ServerDetail,
	ServerDetailTab,
} from "#/features/servers/server-detail.types";

const DEFAULT_SERVER_ICON_URL =
	"https://cdn.discordapp.com/embed/avatars/0.png";
const SERVER_DETAIL_TABS: readonly ServerDetailTab[] = [
	"about",
	"rules",
	"screenshots",
];
...
function validateSearch(search: Record<string, unknown>): ServerDetailSearch {
	const tab =
		...
		SERVER_DETAIL_TABS.includes(search.tab as ServerDetailTab)
