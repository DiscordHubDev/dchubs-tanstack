/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d18f88567105df1bf8f3d24e94f5d6e4)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	DCHUBS_CACHE: KVNamespace;
	BANNED_USERS: KVNamespace;
	"dchubs-db": Hyperdrive;
	ASSETS: Fetcher;
	NIXPACKS_NODE_VERSION: string;
	...
	ASSET_PRELOAD_MAX_SIZE: string;
	ASSET_PRELOAD_INCLUDE_PATTERNS: string;
	ASSET_PRELOAD_EXCLUDE_PATTERNS: string;
	ASSET_PRELOAD_ENABLE_ETAG: string;
	ASSET_PRELOAD_ENABLE_GZIP: string;
	GATEWAY_SECRET: string;
	VITE_ADMIN_IDS: string;
	API_CRON_TOKEN: string;
	CLOUDFLARE_ACCOUNT_ID: string;
	AWS_ACCESS_KEY_ID: string;
	AWS_SECRET_ACCESS_KEY: string;
	VOTE_WEBHOOK_URL: string;
	APPROVED_WEBHOOK_URL: string;
	PENDING_WEBHOOK_URL: string;
	SERVER_WEBHOOK_URL: string;
	REPORT_WEBHOOK_URL: string;
	CF_ACCOUNT_ID: string;
	CF_BANNED_USERS_KV_ID: string;
	REDIS_URL: string;
	NODE_ENV: string;
	VITE_SITE_URL: string;
	BETTER_AUTH_CONFIG_PATH: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NIXPACKS_NODE_VERSION" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "JWT_SECRET" | "REFRESH_JWT_SECRET" | "DISCORD_BOT_TOKEN" | "DATABASE_URL" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_UPLOAD_PRESET" | "ASSET_PRELOAD_MAX_SIZE" | "ASSET_PRELOAD_INCLUDE_PATTERNS" | "ASSET_PRELOAD_EXCLUDE_PATTERNS" | "ASSET_PRELOAD_ENABLE_ETAG" | "ASSET_PRELOAD_ENABLE_GZIP" | "GATEWAY_SECRET" | "VITE_ADMIN_IDS" | "API_CRON_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "VOTE_WEBHOOK_URL" | "APPROVED_WEBHOOK_URL" | "PENDING_WEBHOOK_URL" | "SERVER_WEBHOOK_URL" | "REPORT_WEBHOOK_URL" | "CF_ACCOUNT_ID" | "CF_BANNED_USERS_KV_ID" | "REDIS_URL" | "NODE_ENV" | "VITE_SITE_URL" | "BETTER_AUTH_CONFIG_PATH">> {}
}
